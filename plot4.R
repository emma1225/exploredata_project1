...
par(mfrow=c(2,2))
with(electric,plot(Date,Global_active_power,type="l",xlab=" ",ylab="Global Active Power"))
with(electric,plot(Date,Voltage,type="l",xlab="datetime"))
...
with(electric,plot(Date,Global_reactive_power,type="l",xlab="datetime"))
dev.off()
